...
import { getFeatures } from "@/src/actions/client/features.actions";
import Content from "./_components/content";
import UpdateVideo from "./_components/video";
export default function FeaturesPage() {
  ...
  return (
    <section className={"flex flex-col gap-4 mb-4.5"}>
      ...
      <UpdateVideo existingData={existingData?.data as any} refetch={refetch} />
    </section>
  );
}
