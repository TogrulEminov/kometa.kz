...
import { getStatisticsData } from "@/src/actions/client/statistics.actions";
...
export default function StatisticsAdminPage() {
  ...
  const columns: Column<StatisticsItem>[] = [
    createImageTitleColumn<StatisticsItem>(),
    createStatusColumn<any>(),
    createCreatedAtColumn<StatisticsItem>(),
    createUpdatedAtColumn<StatisticsItem>(),
  ];
  ...
  return (
    <div>
      <WhiteBlockTitleArea
        title="Statistikalar"
        link="/manage/statistics/create?locale=az"
      />
      <SearchingArea link="manage/statistics" />
      <Suspense
        fallback={
          <div
            style={{
      ...
      >
        <TableTypesArea<StatisticsItem>
          columns={columns}
          page="statistics"
          model="statistics"
          dataItems={(data?.data as unknown as StatisticsItem[]) || []}
          isError={isError}
          refetch={refetch}
          locale={locale}
          invalidateQueryKey="statistics"
          isLoading={isLoading}
        />
      </Suspense>
