...
import { updateServicesMainImage } from "@/src/actions/client/service.actions";
interface Props {
  data: ServicesItem;
  refetch: () => void;
}
export default function ServiceUpdateImage({
  data: existingData,
  refetch,
}: Props) {
  ...
  const onSubmit = async (data: ImgInput) => {
    ...
    startTransition(async () => {
      try {
        const result = await updateServicesMainImage(existingData.documentId, {
